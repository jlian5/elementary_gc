...
CFLAGS_RELEASE=$(CFLAGS_COMMON) -O3 -fno-omit-frame-pointer
...
.PHONY: scan
scan: $(TESTERS_EXE_DIR)/stack_scan-debug
	$(TESTERS_EXE_DIR)/stack_scan-debug

.PHONY: scan_mreplace
scan_mreplace: $(TESTERS_EXE_DIR)/stack_scan-debug
